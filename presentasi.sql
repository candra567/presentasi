...
(5, '2022_07_23_115326_create_table_siswa', 1);
...
CREATE TABLE `table_siswa` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name_siswa` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `no_siswa` int(10) UNSIGNED NOT NULL,
  `kelas_siswa` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
